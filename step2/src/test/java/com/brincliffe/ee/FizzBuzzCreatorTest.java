...
public class FizzBuzzCreatorTest {
    ...
    public void shouldReturnFizzWhenGivenAMultipleOf3() {
        List<String> convertedValues = FizzBuzzCreator.generate(6,6);
    ...
    public void shouldReturnASequence() {
        ...
        assertThat(convertedValues.get(2), is("lucky"));
        ...
        assertThat(convertedValues.get(12), is("lucky"));
    ...
    public void shouldHandleNegativeRanges() {
        ...
        assertThat(convertedValues.get(8), is("lucky"));
        assertThat(convertedValues.get(9), is("4"));
        assertThat(convertedValues.get(10), is("buzz"));
    }

    @Test
    public void shouldReturnLuckyWhenGivenAValueContaining3() {
        List<String> convertedValues = FizzBuzzCreator.generate(13,13);

        assertThat(convertedValues, is(notNullValue()));
        assertThat(convertedValues.size(), is(1));
        assertThat(convertedValues.get(0), is("lucky"));
    }

    @Test
    public void shouldReturnLuckyWhenGivenAValueContaining3ThatIsAMultipleOf3() {
    ...
    @Test
    public void shouldReturnLuckyWhenGivenAValueContaining3ThatIsAMultipleOf5() {
        List<String> convertedValues = FizzBuzzCreator.generate(35,35);
    ...
    @Test
    public void shouldReturnLuckyWhenGivenAValueContaining3ThatIsAMultipleOf15() {
        List<String> convertedValues = FizzBuzzCreator.generate(300,300);
